...
export default function Contract() {
  ...
  useEffect(() => console.log('Contract Info', contractInfo), [ ]);
  ...
  return (
    <div style={ {
      margin: 'auto', display: 'flex', gap: '20px', marginTop: '25', width: '70vw',
    } }
    >
      <Card
        title={ (
          ...
          onFormFinish={ async (name, { forms }) => {
            ...
            if (!isView) {
              ...
              Moralis.executeFunction(options)
                .then(response => setResponses({ ...responses, [name]: { result: response, isLoading: false } }));
            }
          } }
        >
